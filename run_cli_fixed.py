#!/usr/bin/env python3
"""
CivicPulse - Command Line Interface (Fixed UTF-8)
"""
...
print("Setting up CivicPulse CLI...")

# Create directories
for d in ['src', 'tests', '.agent/skills']:
    (project / d).mkdir(parents=True, exist_ok=True)

# Create source files with UTF-8 encoding
...
print("\n" + "="*70)
print("CIVICPULSE - Election Assistant (Command Line)")
print("="*70 + "\n")
...
while True:
    ...
    if user_input.lower() in ['exit', 'quit']:
        print("\nAssistant: Thank you for using CivicPulse. See you at the polls!")
        break
    if user_input:
